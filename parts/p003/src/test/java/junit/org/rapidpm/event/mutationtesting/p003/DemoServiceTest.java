...
public class DemoServiceTest {
  ...
  void test001() throws Exception {
    ...
    Assertions.assertEquals("Tue Mar 12 00:00:00 CET 2019" , convert.toString());
  }
  ...
  void test002() throws Exception {
    ...
    Assertions.assertEquals("Wed Mar 13 00:00:00 CET 2019" , convert.toString());
  }

  @Test
  void test003() throws Exception {
    final Date convert = new DemoService().convert("2019-03-14");
    Assertions.assertEquals("Thu Mar 14 00:00:00 CET 2019" , convert.toString());
  }

  @Test
  void test004() throws Exception {
    final Date convert = new DemoService().convert("2019-03-15");
    Assertions.assertEquals("Fri Mar 15 00:00:00 CET 2019" , convert.toString());
  }
}
